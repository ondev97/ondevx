  ...
  return (
    <>
      <div className="w-full bg-[#F6F9FF]">
        <div className="w-full max-w-[1024px] mx-auto py-14 px-4 flex justify-center relative">
          <div className="w-full flex justify-center md:justify-between items-center flex-wrap gap-4">
            <div className="min-w-[48%] md:min-w-[65px] min-h-[65px] relative overflow-hidden">
              <Image
                src={dockerLogo}
                alt="docker logo"
                fill
